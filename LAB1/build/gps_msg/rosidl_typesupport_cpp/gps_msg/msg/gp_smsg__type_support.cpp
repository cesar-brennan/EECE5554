...
static const _GPSmsg_type_support_symbol_names_t _GPSmsg_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, gps_msg, msg, GPSmsg)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, gps_msg, msg, GPSmsg)),
  }
};
...
{
  return &::gps_msg::msg::rosidl_typesupport_cpp::GPSmsg_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, gps_msg, msg, GPSmsg)() {
  return get_message_type_support_handle<gps_msg::msg::GPSmsg>();
}
