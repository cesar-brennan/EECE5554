...
bool gps_msg__msg__gp_smsg__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("gps_msg.msg._gp_smsg.GPSmsg", full_classname_dest, 27) == 0);
  }
...
ROSIDL_GENERATOR_C_EXPORT
PyObject * gps_msg__msg__gp_smsg__convert_to_py(void * raw_ros_message)
{
  /* NOTE(esteve): Call constructor of GPSmsg */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("gps_msg.msg._gp_smsg");
